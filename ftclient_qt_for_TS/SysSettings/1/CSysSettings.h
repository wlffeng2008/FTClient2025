...
public:
    ...
    bool getHttpPara( std::string& strIP, int& iPort );
    bool setRtmpPara( const std::string& strIP, int iPort );
    bool getMqttPara( std::string& strIP, int&nPort,std::string&strUser,std::string& strPassword);
    bool getRtmpPara( std::string& strIP, int& iPort );
    bool setRtmpDelay_ms( int iDelay_ms );
